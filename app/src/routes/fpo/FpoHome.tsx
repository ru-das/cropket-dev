    ...
    <div className="space-y-6">
      <div className="rounded-2xl border border-line bg-surface p-5 shadow-card">
        <div className="flex items-center gap-3">
          <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-leaf-light text-leaf-dark">
          ...
          <div className="min-w-0 flex-1">
            ...
            <span className="mt-0.5 inline-block rounded-full bg-leaf-light px-2.5 py-0.5 text-xs font-bold text-leaf-dark">
              {t("role.fpo")}
            </span>
          </div>
        </div>
